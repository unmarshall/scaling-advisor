...
/*
	...
	PlanGenerator:
		* Selects a ScaleOutSimulator based on SimulationStrategy
		> Creation of SimulationGroup(s) based on NodePool(s), NodeTemplate(s) and AZ(s) combinations is a responsibility of the ScaleOutSimulator.
		* Invokes ScaleOutSimulator.Run which should return ScaleOutPlan.

	ScaleOutSimulator.Run:
